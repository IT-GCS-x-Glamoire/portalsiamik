    ...
    <?php if(!empty($data)): ?>
        <div class="card card-dark mt-2">
            <div class="card-header header-elements-inline">
                <h5 class="card-title"><?php echo e($data['grade_name']); ?> - <?php echo e($data['grade_class']); ?></h5>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        hiddenDays: [0, 6],
        events: [
            <?php $__currentLoopData = $gradeSchedule; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $event = [
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\siamik-portal-gcs\resources\views/components/student/detail-grade-student.blade.php ENDPATH**/ ?>