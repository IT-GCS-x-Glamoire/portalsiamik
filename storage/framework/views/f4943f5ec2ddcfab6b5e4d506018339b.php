...
<head>
  ...
  <link rel="icon" href="<?php echo e(asset('great.png')); ?>" type="image/x-icon">
...
<body>
            ...
            <form method="POST" action="<?php echo e(route('actionLogin')); ?>">
              ...
              <div class="form-outline mb-4">
                <input type="text" id="form3Example3" class="form-control form-control-lg"
                  placeholder="Enter a valid username" name="username" autocomplete="off" value="<?php echo e(old('username')); ?>"/>
              ...
              <div class="form-outline mb-3">
                <input type="password" id="form3Example4" class="form-control form-control-lg"
                  placeholder="Enter password" name="password" autocomplete="off" value="<?php echo e(old('password')); ?>"/>
  ...
  <?php if($errors->any()): ?>
    ...
    <?php if($errors->first('credentials')): ?>
      <script>
        Swal.fire({
          icon: "error",
    ...
    <?php elseif($errors->first('password')): ?>
    <script>
      Swal.fire({
        icon: "error",
  ...
  <?php if(session('success.update.password')): ?>
   <script>
      Swal.fire({
        icon: 'success',
        title: 'Successfully',
...
<?php /**PATH C:\xampp\htdocs\siamik-portal-gcs\resources\views/layouts/login.blade.php ENDPATH**/ ?>