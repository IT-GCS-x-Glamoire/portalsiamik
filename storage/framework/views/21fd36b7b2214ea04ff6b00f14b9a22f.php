<meta charset="utf-8">
  ...
  <meta name="role" content="<?php echo e(session('role')); ?>">
  ...
  <script src="<?php echo e(asset('template')); ?>/plugins/jquery/jquery.min.js" referrerpolicy="no-referrer"></script>
  ...
  <!-- FullCalendar CSS -->
  <link rel="stylesheet" href="<?php echo e(asset('template')); ?>/plugins/fullcalendar/main.min.css">


  <?php /**PATH C:\xampp\htdocs\siamik-portal-gcs\resources\views/layouts/header.blade.php ENDPATH**/ ?>