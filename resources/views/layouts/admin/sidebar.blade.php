    ...
    <nav class="mt-2">
      ...
      <!-- Add icons to the links using the .nav-icon class
        ...
        <!-- SCORINGS -->
          ...
          @elseif (session('role') == 'teacher') 
          <li class="nav-item">
            <a href="/{{ session('role') }}/dashboard/exam/teacher" class="nav-link {{ session('page') && session('page')->page == 'scorings' ? 'active' : '' }}">
              <i class="nav-icon fa-solid fa-pencil"></i>
              <p>
                Scorings
              </p>
          ...
          <li class="nav-item">
            <a href="/{{ session('role') }}/dashboard/assessment" class="nav-link {{session('page') && session('page')->child? (session('page')->child == 'assessments' ? 'active' : '') : ''}}">
              <i class="nav-icon fa-solid fa-pencil"></i>
              <p>
                Assessments
              </p>
        ...
        <!-- STUDENTS -->
          ...
          <li class="nav-item {{ session('page') && session('page')->page && session('page')->page == 'relations' ? 'menu-open' : '' }}">
            <a href="/superadmin/relations" class="nav-link {{ session('page') && session('page')->child && session('page')->child == 'database relations' ? 'active' : '' }}">
