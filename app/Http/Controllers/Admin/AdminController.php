   ...
   public function actionChangeMyPassword(Request $request)
   {
      ...
      try {
         ...
         if($request->password !== $request->reinputPassword)
         {
            ...
            return redirect('/superadmin/user/change-password')->withErrors([ 
         ...
         if($validator->fails())
         {
            ...
            return redirect('/superadmin/user/change-password')->withErrors($validator->messages())->withInput($rules);
         }
